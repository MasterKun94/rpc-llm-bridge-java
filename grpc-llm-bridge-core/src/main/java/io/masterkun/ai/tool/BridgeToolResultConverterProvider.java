...
public interface BridgeToolResultConverterProvider<T> {
    /**
     * Creates and returns a new result converter instance. This method should return a fresh
     * converter that can transform results of type T to string representations.
     *
