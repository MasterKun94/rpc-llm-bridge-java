...
public interface BridgeToolCallback<T> {
    ...
    /**
     * Returns the definition of this tool. The definition contains metadata about the tool such as
    ...
    /**
     * Returns the metadata associated with this tool. The metadata provides additional information
     * about the tool's capabilities and requirements.
     *
    ...
    /**
     * Executes the tool operation with the provided input. This method processes the input string
