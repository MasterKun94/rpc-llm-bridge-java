...
public interface BridgeToolDefinition<T> {
    ...
    /**
     * Returns the name of the tool. The name should be unique and descriptive of the tool's
     * functionality.
     *
    ...
    /**
     * Returns the description of the tool. The description should provide a clear explanation of
     * what the tool does and how it should be used.
     *
    ...
    /**
     * Returns the schema for the tool's input. The schema defines the structure and constraints of
     * valid inputs for the tool.
     *
     ...
     * transforms the tool's native result type to the desired output format.
     *
